					...
					<div class="layui-card-body" pad15="">
						...
						<div class="layui-form" lay-filter="">
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-inline">
									<input type="text" name="username" value="feng" readonly=""
										class="layui-input">
								</div>
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-inline">
									<input type="text" name="nickname" value="冯鑫龙"
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									...
									<div class="layui-unselect layui-form-radio layui-form-radioed" checked="true">
