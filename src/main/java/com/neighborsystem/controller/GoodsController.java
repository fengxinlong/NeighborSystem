...
public class GoodsController {
	...
	@RequestMapping("findAllDonations")
	@ResponseBody
	public JSONObject findAllDonations(){
		Goods good = goodsService.findAllDonations();
		String[] name = new String[1];
		Integer[] volume=new Integer[1];
		name[0]=good.getGoodsName();
		volume[0]= good.getGoodsVolume()*200;
