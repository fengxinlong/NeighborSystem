...
<body style="background-color:#F2F2F2;padding-top:15px;padding-left:15px;padding-bottom:0px;">
	...
	<%--<div class="layui-card" style="width: 560px; height: 310px;float:left;margin-left:15px;">--%>
		<%--<div class="layui-card-header">疫情报告分析</div>--%>
		<%--<div class="layui-card-body" id="patientState" style="width: 520px; height: 260px;"></div>--%>
	<%--</div>--%>
	<div class="layui-card" style="width: 560px; height: 310px;float:left;margin-left:15px;">
		<div class="layui-card-header">疫情捐款总额</div>
		<div class="layui-card-body" id="patientState" style="width: 560px; height: 260px;"></div>
	</div>



	<div class="layui-card" style="width: 560px; height: 310px;float:left;margin-left:15px;">
		<div class="layui-card-header">销量排行</div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		var patientChart=echarts.init(document.getElementById('patientState','wonderland'))
		var layer;
		...
		patientChart.showLoading();
		$.ajax({
			type:"post",
			url:"goods/findAllDonations",
			dataType: "json",
			success:function(res){
			    patientChart.hideLoading();
			    patientChart.setOption({
					xAxis:{
					    data:res.name
					},series:[{
